...
const openAttestationDatav2: v2.OpenAttestationDocument & { foo: string } = {
  issuers: [
    {
      name: "John",
      identityProof: {
...
describe("Util Functions", () => {
  ...
  let wrappedV3DidDocument: WrappedDocument<v3.OpenAttestationDocument>;
  let wrappedTransferableV3Document: WrappedDocument<v3.OpenAttestationDocument>;
  const wrappedV2Document: WrappedDocument<v2.OpenAttestationDocument> = wrapDocument(openAttestationDatav2);
  ...
  beforeAll(async () => {
    ...
    wrappedV3DidDocument = await __unsafe__use__it__at__your__own__risks__wrapDocument(
      {
        "@context": [
          "https://www.w3.org/2018/credentials/v1",
          "https://www.w3.org/2018/credentials/examples/v1",
