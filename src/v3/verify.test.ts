...
describe("signature", () => {
  describe("verify", () => {
    ...
    describe("documents with proofs", () => {
      ...
      test("returns true for documents with missing proofs, and altered merkleRoot to be the targetHash", () => {
        /* In this test, we used a batched document (i.e. targetHash !== merkleRoot) but we:
         *   1. removed the proofs, and
         *   2. made merkleRoot the same as targetHash
         *
         * Now, verifying this document would return true BUT it will likely fail the
