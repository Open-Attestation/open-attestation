...
describe("salt", () => {
  ...
  describe("unsalt value", () => {
    it("should unsalt numbers", () => {
      ...
      expect(unsalt("ee7f3323-1634-4dea-8c12-f0bb83aff874: 51234")).to.equal(
        51234
      );
      expect(
        unsalt("ee7f3323-1634-4dea-8c12-f0bb83aff874: 51234.54321")
      ).to.equal(51234.54321);
    });
    it("should unsalt booleans", () => {
      expect(unsalt("ee7f3323-1634-4dea-8c12-f0bb83aff874: true")).to.equal(
        true
      );
      expect(unsalt("ee7f3323-1634-4dea-8c12-f0bb83aff874: false")).to.equal(
        false
      );
    });
    it("should unsalt strings", () => {
      expect(unsalt("ee7f3323-1634-4dea-8c12-f0bb83aff874: abcd")).to.equal(
        "abcd"
      );
    });
