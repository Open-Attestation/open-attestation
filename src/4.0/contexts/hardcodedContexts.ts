...
export const HARDCODED_CONTEXTS: Record<(typeof ContextUrl)[keyof typeof ContextUrl], any> = {
  ...
  "https://schemata.openattestation.com/com/openattestation/4.0/context.json": {
    "@context": {
        ...
        "@context": {
          ...
          identityProof: {
            ...
            "@context": {
              ...
              identifier: {
                "@id": "oacred:identityProofIdentifier",
      ...
      OpenAttestationEmbeddedRenderer: {
        ...
        "@context": {
          templateName: "oacred:renderTemplateName",
        },
      },
      OpenAttestationMerkleProofSignature2018: {
        ...
        "@context": {
          ...
          privacy: {
            ...
            "@context": {
              obfuscated: {
                "@id": "oacred:proofPrivacyObfuscated",
                "@container": "@list",
              },
            },
          },
