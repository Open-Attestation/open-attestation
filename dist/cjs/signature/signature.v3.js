...
var deepMap = function (value, path) {
    ...
    if (typeof value === "string") {
        return [{ value: uuid_1.v4(), path: path }];
    }
...
var digestDocument = function (document, salts, obfuscatedData) {
    ...
    var hashedUnhashedDataArray = salts
        ...
        return js_sha3_1.keccak256(JSON.stringify(salt.value + ":" + lodash_1.get(document, salt.path)));
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, jsonld_1.compact(credential, "https://w3id.org/security/v2", {
...
exports.wrapV3 = function (document) {
    ...
    var batchBuffers = [digest].map(utils_1.hashToBuffer);
...
exports.wrapsV3 = function (documents) {
    ...
    var batchBuffers = digests.map(utils_1.hashToBuffer);
    var merkleTree = new merkle_1.MerkleTree(batchBuffers);
    var merkleRoot = merkleTree.getRoot().toString("hex");
...
var obfuscateData = function (_data, fields) {
    ...
    var obfuscatedData = fieldsToRemove
        .filter(function (field) { return lodash_1.get(data, field); })
        .map(function (field) {
        ...
        return utils_1.toBuffer(salt.value + ":" + value).toString("hex");
    });
