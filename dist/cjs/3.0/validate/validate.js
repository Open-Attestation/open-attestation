...
var nodeDocumentLoader = jsonld_1.documentLoaders.xhr ? jsonld_1.documentLoaders.xhr() : jsonld_1.documentLoaders.node();
var preload = true;
            ...
            case 0:
                if (preload) {
                    ...
                    for (_i = 0, preloadedContextList_1 = preloadedContextList; _i < preloadedContextList_1.length; _i++) {
                        ...
                        contexts.set(url_1, node_fetch_1.default(url_1, { headers: { accept: "application/json" } }).then(function (res) { return res.json(); }));
                    }
                }
