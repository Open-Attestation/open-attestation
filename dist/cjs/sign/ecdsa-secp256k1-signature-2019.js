...
var type = document_1.ProofType.EcdsaSecp256k1Signature2019;
/**
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    proofPurpose = options.proofPurpose || document_1.ProofPurpose.AssertionMethod;
                    msg = document.signature.targetHash;
                    return [4 /*yield*/, new ethers_1.ethers.Wallet(privateKey).signMessage(msg)];
                case 1:
                    signature = _a.sent();
