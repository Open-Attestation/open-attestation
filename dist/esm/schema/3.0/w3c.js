...
export var __unsafe__mapToW3cVc = function (document) {
    var _a = getData(document), proof = _a.proof, issuer = _a.issuer, evidence = _a.evidence, type = _a.type, validFrom = _a.validFrom, validUntil = _a.validUntil, context = _a["@context"], rest = __rest(_a, ["proof", "issuer", "evidence", "type", "validFrom", "validUntil", "@context"]);
