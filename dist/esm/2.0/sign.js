...
export var signDocument = function (document, algorithm, keyOrSigner) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_d.label) {
            ...
            case 4:
                proof = (_c.verificationMethod = _a,
                    ...
                    _c);
                return [2 /*return*/, __assign(__assign({}, document), { proof: isSignedWrappedV2Document(document) ? __spreadArray(__spreadArray([], document.proof), [proof]) : [proof] })];
        }
    });
}); };
