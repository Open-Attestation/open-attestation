...
import { ProofPurpose, ProofType } from "../@types/document";
import { ethers } from "ethers";
var type = ProofType.EcdsaSecp256k1Signature2019;
/**
 ...
 * @param options
 */
export function sign(document, options) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    proofPurpose = options.proofPurpose || ProofPurpose.AssertionMethod;
                    msg = document.signature.targetHash;
                    return [4 /*yield*/, new ethers.Wallet(privateKey).signMessage(msg)];
                case 1:
                    signature = _a.sent();
